...
enum KeywordType
{
    ...
    KEYWORD_TYPE_RAMSET      = 0x17,
};

enum SeparatorType {
    SEPARATOR_TYPE_PAR_OPEN    = 0x18,
    SEPARATOR_TYPE_PAR_CLOSE   = 0x19,
    SEPARATOR_TYPE_COMMA       = 0x1A,
    SEPARATOR_TYPE_SEMICOLON   = 0x1B,
    SEPARATOR_TYPE_CURLY_OPEN  = 0x1C,
    SEPARATOR_TYPE_CURLY_CLOSE = 0x1D,
};
...
ATTR_UNUSED static TokenInfo TokenArr[] = 
{
    ...
    MAKE_KEYWORD  ("ramset", "RAMSET"      , TYPE_KEYWORD   , KEYWORD_TYPE_RAMSET     ),
